...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const [selectedClass, setSelectedClass] = useState('10A8');
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-[11px] text-slate-300">
              ...
              <div className="relative inline-block">
                ...
                >
                  <option value="10A8">Lớp 10A8 (36 HS)</option>
                  <option value="11A8">Lớp 11A8 (40 HS)</option>
                  <option value="12A8">Lớp 12A8 (38 HS)</option>
                </select>
              </div>
